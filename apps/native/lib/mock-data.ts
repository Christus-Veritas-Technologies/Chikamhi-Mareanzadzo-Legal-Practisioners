...
// Client/Matter/Document Prisma models + API endpoints exist. Mirrors apps/web/src/lib/mock-data.ts
// (kept as a duplicate, not a shared package, per the "self-contained per app" rule).
...
export function getDocument(documentId: string | undefined) {
  return DOCUMENTS.find((d) => d.id === documentId);
}

export function getClient(clientId: string | undefined) {
